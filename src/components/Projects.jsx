    ...
    <section id="projects" className="projects-section">
      ...
      <div className="projects-grid">
        ...
        <div className="project-card">
          <h3>Video Player</h3>
          <img src="" alt="" />
          <p>🚀 Just built a video player app with React & MongoDB! 🎬 Upload, play, and your videos stay saved even after reloading with all videoplayer features (eg double click fullscreen etc). Check it out!</p>
